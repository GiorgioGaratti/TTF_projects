...
CREATE TABLE `tbl_firma` (
  ...
  KEY `IDXFK_GIORNO_PRESENZA_FIRMA` (`numero_corso`,`data`) /*!80000 INVISIBLE */,
...
CREATE TABLE `tbl_lezione` (
  ...
  KEY `IDXFK_GIORNO_PRESENZA_LEZIONE` (`numero_corso`,`data`),
...
-- Dump completed on 2022-03-21  8:27:21
